...
This data is untidy because it uses characters in the columns. 
...
That data isn't tidy because the days are listed as columns 
...
```
## # A tibble: 90 × 5
##    genotype water_sched_prog greenhouse days  height
##    <chr>    <chr>            <chr>      <chr>  <dbl>
...
```
## [1] "/Users/maggiebauer/Downloads/Untitled/BIS15W2022_mbauer/lab8"
```
