...
```
## here() starts at /Users/maggiebauer/Downloads/Untitled/BIS15W2022_mbauer
```
...
```r
enterococci <- readr::read_csv("data/sydneybeaches.csv")
```
...
Yes, the column names aren't part of the data set. This is in a long format.  
...
```r
 sydeneybeaches_mean <- sydneybeaches_long_seperate %>% 
  group_by(site, year) %>% 
...
##    site                    year    mean
##    <chr>                   <chr>  <dbl>
##  1 Maroubra Beach          2018    9.21
##  2 Clovelly Beach          2018   10.6 
##  3 South Maroubra Beach    2018   12.5 
##  4 Tamarama Beach          2018   15.5 
##  5 Gordons Bay (East)      2018   17.6 
##  6 Coogee Beach            2018   21.6 
##  7 Bondi Beach             2018   22.9 
##  8 Malabar Beach           2018   38.0 
##  9 Bronte Beach            2018   43.4 
## 10 Little Bay Beach        2018   59.1 
## 11 South Maroubra Rockpool 2018  112.
```
