...
expenditures <- 
  USPersonalExpenditure %>% 
  as_tibble() %>% # make the data into a data frame
...
## Practice
1. Are these data tidy? Please use `pivot_longer()` to tidy the data. No- years are data
...
## # … with 56 more rows
```
Pivot- when colomn names are data 
## Wrap-up  
