...
R is the programming language while R studio helps to write R programs. R is needed to use RStudio. GitHub is a way of storing different files in repositories as edits are made. It also allows collaboration. 
