...
homerange %>% 
  ...
  geom_violin(alpha = .3, na.rm = TRUE)+ geom_boxplot(color = "grey", alpha = .3, na.rm = TRUE) 
```

3. What information can you gather from the violin plot that might have been missed with the box plot?
You can get a better idea of the overall distribution of the data 
...
Drug d-raises heart rate; drug c-raises it 
