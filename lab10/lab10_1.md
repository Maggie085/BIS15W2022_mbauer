...
## 17 Tubulidentata      1
```
count same as group by and summarize
...
## 17 Xenarthra          7238.
```
Wants to put everything in scientific notation 
...
rel-relative size; title and x and y scaled relative to each other
## Other Aesthetics
...
homerange %>% 
  ...
  labs(title="Count of Ectotherms vs. Endotherms",
...
homerange %>% 
  ...
  labs(title="Log10Mass vs. Homerange Area",
       x="Log10 Mass",
       y="Homerange Area")
```
