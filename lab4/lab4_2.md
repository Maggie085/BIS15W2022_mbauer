...
Notice that the `|` operator generates a different result. = to or
...
```r
mammals_focused <- select(mammals,"family","genus","species","mass","gestation")
mammals_focused
```
...
```r
filter(mammals_focused, mass >= 450000 & family=="Bovidae")
```
...
```r
mammals_2 <- filter(mammals, genus %in% c("Lophocebus", "Erythrocebus", "Macaca"))
mammals_2
```
...
##    order  family genus species   mass gestation newborn weaning wean_mass    afr
##    <chr>  <chr>  <chr> <chr>    <dbl>     <dbl>   <dbl>   <dbl>     <dbl>  <dbl>
##  1 Prima… Cerco… Eryt… patas    5883.      5.56    546.    5.33     1950    32.8
##  2 Prima… Cerco… Loph… albige…  6726.      5.97    462.    7.67     2170    57.6
##  3 Prima… Cerco… Maca… thibet… 10037.      5.67    533.   18.8      2400  -999  
##  4 Prima… Cerco… Maca… fuscata  8858.      5.72    505.   12.1      1768.   55.0
##  5 Prima… Cerco… Maca… maura    5575       5.43    390.   16.7      -999    60  
##  6 Prima… Cerco… Maca… sylvan…  9753.      5.49    450     7        2420    49.8
##  7 Prima… Cerco… Maca… arctoi…  7308.      6       486.   11.2      2300    47.8
##  8 Prima… Cerco… Maca… nigra    6212.      5.78    458.    7        -999    63.2
##  9 Prima… Cerco… Maca… sinica   3495    -999       446    13.0      -999    54  
## 10 Prima… Cerco… Maca… silenus  4875       5.94    418    12        -999    53.2
## 11 Prima… Cerco… Maca… mulatta  5413.      5.47    476.    9.47     1454    41.1
## 12 Prima… Cerco… Maca… cyclop…  6317.      5.4     401     6.87     -999  -999  
## 13 Prima… Cerco… Maca… nemest…  6133.      5.71    476.   10.7      1416.   43.6
## 14 Prima… Cerco… Maca… fascic…  3456.      5.49    408.    9.58      990.   43.6
## 15 Prima… Cerco… Maca… radiata  3735       5.43    391.   10.7      2000    45.4
## # … with 3 more variables: max_life <dbl>, litter_size <dbl>,
## #   litters_per_year <dbl>
```
...
```r
select(mammals_2, "species", "mass", "gestation", "newborn")
```

```
## # A tibble: 15 × 4
##    species        mass gestation newborn
##    <chr>         <dbl>     <dbl>   <dbl>
##  1 patas         5883.      5.56    546.
##  2 albigena      6726.      5.97    462.
##  3 thibetana    10037.      5.67    533.
##  4 fuscata       8858.      5.72    505.
##  5 maura         5575       5.43    390.
##  6 sylvanus      9753.      5.49    450 
##  7 arctoides     7308.      6       486.
##  8 nigra         6212.      5.78    458.
##  9 sinica        3495    -999       446 
## 10 silenus       4875       5.94    418 
## 11 mulatta       5413.      5.47    476.
## 12 cyclopis      6317.      5.4     401 
## 13 nemestrina    6133.      5.71    476.
## 14 fascicularis  3456.      5.49    408.
## 15 radiata       3735       5.43    391.
```
maura
## Wrap-up  
